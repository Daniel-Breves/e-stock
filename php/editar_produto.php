...
<html lang="en">
  ...
  <body class="bg-slate-100 flex justify-center">
    <form class="bg-white shadow-2xl rounded-xl w-150 h-180 mt-20 flex flex-col justify-center" id="form-produto" method="post" action="update_pr.php">
...
<input type="hidden" name="id_estoque" value="<?php echo $produto['id_estoque']; ?>">
    ...
    <input class="border-1 rounded ml-5 mr-5 h-10 w-125" type="number" name="quanti" value="<?php echo htmlspecialchars($produto['quantidade']); ?>"
        </div>
        <div class="ml-5 mr-5">
    ...
    <button class="bg-blue-800 text-white shadow-xl rounded-lg hover:bg-blue-700 h-10 w-35" type="submit">Salvar Alterações</button>
            <a class="text-blue-700 font-medium hover:text-blue-800 ml-3" href="estoque.php?id=<?php echo $produto['id_estoque']; ?>">voltar</a>
        </div>
</form>
  </body>
</html>